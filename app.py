...
def dima_google():
    ...
    conn = mysql.connect()
    cursor = conn.cursor()
    sql = "INSERT INTO dima_google_ibot(project_name, date, type_profile, target_url, key_serp, key_position, get_params, " \
          "id_query_record_bd, profile_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
    cursor.execute(sql,
                   (arg_project_name, arg_date, arg_type_device, arg_target_url, arg_query, arg_position, arg_get_param,
                    arg_record_id, arg_profile_id))
...
def dima_yandex():
    ...
    conn = mysql.connect()
    cursor = conn.cursor()
    sql = "INSERT INTO dima_yandex_ibot(project_name, date, type_profile, target_url, key_serp, key_position, get_params, " \
          "id_query_record_bd, profile_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
    cursor.execute(sql,
                   (arg_project_name, arg_date, arg_type_device, arg_target_url, arg_query, arg_position, arg_get_param,
                    arg_record_id, arg_profile_id))
